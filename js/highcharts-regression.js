    ...
    H.wrap(H.Chart.prototype, 'init', function (proceed) {
        ...
        for (i = 0 ; i < series.length ; i++){
            ...
            if ( s.regression && !s.rendered ) {
                ...
                s.regressionSettings.dashStyle = s.regressionSettings.dashStyle || 'dash';
                ...
                var extraSerie = {
                        ...
                        name: s.regressionSettings.name || "Deviation: %r2", 						
                        color: s.regressionSettings.color || 'rgba(119, 5, 191, .5)',
